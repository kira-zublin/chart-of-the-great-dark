...
The character editor now has Profile, Abilities, Condition, and Gear tabs. A separate shared Crew Sheet records five character roles, maneuvers, Crew Points, Bird, rover, and shuttle details. Signed-in players can edit the crew record; a player may assign only their own PC to a role, while the GM may assign any PC. The Crew Sheet refreshes every four seconds while open and rejects stale writes.
